...
import { Eye, Download, User, Calendar, FileText, Filter, Plus, Briefcase, Mail, Phone, Clock } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {positionsLoading ? (
              ...
              positions.map((position) => (
                <div key={position.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div className="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
              <div className="mt-3">
                ...
                <div className="flex justify-end space-x-3 mt-6">
                  ...
                  >
                    {createPositionMutation.isPending ? 'Posting...' : 'Post Job'}
                  </button>
                </div>
              </div>
            </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredApplications.map((application) => (
                    <tr key={application.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{application.position?.title || application.position}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
