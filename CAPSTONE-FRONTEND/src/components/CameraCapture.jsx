          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                disabled={isConfirming}
                className="flex-1 px-4 py-2 bg-[#8b1e3f] text-white rounded-lg hover:bg-[#7a1a37] disabled:bg-[#8b1e3f]/60 transition-colors flex items-center justify-center space-x-2 disabled:cursor-not-allowed"
              >
                {isConfirming ? (
                  <>
